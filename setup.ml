...
(* OASIS_START *)
(* DO NOT EDIT (digest: 88927aa4085d4a797994e18d11ff250b) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dlist_bench.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dlist_test.ml"; });
               Test
                 ({
                     cs_name = "unit_test";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/BYVoid/Dlist.git";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ËÎ8;\130©\001¿\015ZÍ\139*Èwå";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
